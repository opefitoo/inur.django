    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateTimeField(verbose_name='Date')),
                ('end_date', models.TimeField(verbose_name='Heure fin')),
                ('coordinates_at_start_date', django.contrib.gis.db.models.fields.PointField(blank=True, null=True, srid=4326)),
                ('coordinates_at_end_date', django.contrib.gis.db.models.fields.PointField(blank=True, null=True, srid=4326)),
