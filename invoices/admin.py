...
class InvoiceItemAdmin(AjaxSelectAdmin):
    ...
    from invaction import previous_months_invoices_october, previous_months_invoices_november, previous_months_invoices_february, previous_months_invoices_january
    ...
    actions = [pdf_private_invoice, export_to_pdf, previous_months_invoices_october, previous_months_invoices_november, previous_months_invoices_february, previous_months_invoices_january]
