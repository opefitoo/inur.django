...
class InvoiceItemAdmin(AjaxSelectAdmin):
    ...
    from invaction import previous_months_invoices_jan, previous_months_invoices_feb
    ...
    actions = [export_to_pdf, pdf_private_invoice_pp, pdf_private_invoice, previous_months_invoices_feb, previous_months_invoices_jan]
