...
from invoices.actions.invoices import generer_forfait_aev_avril_2024
...
class PatientAdmin(CSVExportAdmin):
    ...
    form = PatientForm
    actions = [generer_forfait_aev_avril_2024, "generate_annual_report_for_2023",
...
class EventListAdmin(admin.ModelAdmin):
    list_display = ['day', 'time_start_event', 'time_end_event', 'patient', 'employees', 'state', 'created_on']
