...
class InvoiceItemAdmin(AjaxSelectAdmin):
    ...
    from invaction import previous_months_invoices_february_2017, previous_months_invoices_jan_2017
    ...
    actions = [export_to_pdf, pdf_private_invoice_pp, pdf_private_invoice, previous_months_invoices_jan_2017,previous_months_invoices_february_2017]
