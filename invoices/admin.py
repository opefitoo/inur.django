...
class InvoiceItemAdmin(AjaxSelectAdmin):
    ...
    from invaction import previous_months_invoices_july
    from generate_pacifico_invoices import mousel_ordonnance
    ...
    actions = [pdf_private_invoice, export_to_pdf, pdf_private_invoice_with_recap, previous_months_invoices_july, mousel_ordonnance]
