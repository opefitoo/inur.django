...
def search_for_missing_important_infos(important_fields = DEFAULT_IMPORTANT_FIELDS, app_label=DEFAULT_APP_LABEL):
    rslt=[]
    for field_info in important_fields:
        ...
        for rec in records_with_missing_infos:
            ...
            message_for_link = "You can update the missing info by following the link %s%s" % (BASE_URL,rec_admin_url)
