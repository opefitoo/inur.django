...
urlpatterns += [
    # ... other URL patterns ...
    path('api/', include('api.urls')),  # assuming 'api.urls' is the location of your secondary urls.py file
    # ... other URL patterns ...
]
urlpatterns += [
...
urlpatterns += [
    # Serve the Angular app's index.html from /mt940-ofx
    path('invoices/newcarlist/', TemplateView.as_view(template_name='angular-car/app-car-list.html')),
]
# if settings.DEBUG:
