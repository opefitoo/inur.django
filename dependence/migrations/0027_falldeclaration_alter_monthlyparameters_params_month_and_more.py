        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("FRMA_RADIO", "Radiological investigation"),
                            ("FRMA_MINOR_SURGERY", "Minor surgery"),
                            ("FRMA_TRANSFER", "Transfer"),
                            ("FRMA_NURS_SUPERV", "Increased nursing supervision"),
                            ("FRMA_RESTRAINT", "Restraint"),
                        ],
                        max_length=255,
                        verbose_name="Required medical and/or nursing act",
                    ),
                ),
                (
                    "fall_declaration",
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        choices=[
                            ("FCMD_URINARY", "Urinary incontinence (not catheterized)"),
                            ("FI_FECAL", "Incontinence of feces"),
                        ],
                        default=None,
                        max_length=255,
                        null=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("FCO_NO_TRAUMA", "Free from traumatic injuries"),
                            (
                                "FCO_SUPERF_TRAUMA",
                                "Superficial traumatic lesion(s) (abrasion, contusion, bruise, hematoma)",
                            ),
                            ("FCO_OPEN_WOUND", "Open wound(s) (cut, laceration)"),
                            ("FCO_DISLOCATION", "Dislocation, sprain, strain"),
                            ("FCO_PAIN", "Pain (please assess pain)"),
                        ],
                        max_length=255,
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        choices=[
                            ("FCMD_DROWSINESS_ETC", "Drowsiness, stupor or coma"),
                            ("FCMD_DESORIENT", "Disorientation, confusion"),
                            ("FCMD_AGET", "Agitation"),
                            ("FCMD_OTHER", "Other impairments of cognitive functions"),
                        ],
                        default=None,
                        max_length=255,
                        null=True,
                        verbose_name="Cognitive and/or mood disorder",
                    ),
                ),
                (
                    "fall_declaration",
