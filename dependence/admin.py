...
from dependence.actions.monthly import create_assurance_dependance_invoices_june_2023, \
    create_assurance_dependance_invoices_june_selected_patient_2023
...
class MedicalCareSummaryPerPatientAdmin(admin.ModelAdmin):
    ...
    actions = [create_assurance_dependance_invoices_june_2023, create_assurance_dependance_invoices_june_selected_patient_2023]
