...
from dependence.actions.monthly import create_assurance_dependance_invoices_july_2023, \
    create_assurance_dependance_invoices_august_2023
...
class MedicalCareSummaryPerPatientAdmin(admin.ModelAdmin):
    ...
    actions = [create_assurance_dependance_invoices_july_2023, create_assurance_dependance_invoices_august_2023]
